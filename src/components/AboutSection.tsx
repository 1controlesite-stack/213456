...
const AboutSection = () => {
  ...
  const imageReveal = useScrollReveal({ threshold: 0.15 });
  const textReveal = useScrollReveal({ threshold: 0.15 });

  return (
    <section className="relative py-20 md:py-28 overflow-hidden" aria-labelledby="sobre-heading">
      ...
      <div className="container relative">
        <div className="grid items-center gap-12 md:grid-cols-12">
          <div
            ref={imageReveal.ref}
            className={`reveal-left flex justify-center md:order-1 md:col-span-5 ${imageReveal.isVisible ? "visible" : ""}`}
          >
            <div className="relative">
              ...
              <div className="relative aspect-[3/4] w-full max-w-sm overflow-hidden rounded-lg shadow-xl shadow-primary/10">
                <img
                  ...
                  loading="lazy"
                  src="/lovable-uploads/f0846bc0-4a13-4f7a-a90d-5aad79202deb.jpg"
                />
              </div>
            </div>
          </div>
          ...
          <div
            ref={textReveal.ref}
            className={`reveal-right md:order-2 md:col-span-7 ${textReveal.isVisible ? "visible" : ""}`}
          >
            <p className="font-amoresa text-xl text-gold">Sobre</p>
            <h2
              id="sobre-heading"
              className="mt-2 font-serif text-3xl font-semibold text-primary md:text-4xl"
            >
              Célia Franz
            </h2>
            ...
            <Button
              variant="outline"
              className="mt-6 border-primary/20 text-primary shadow-sm hover:bg-primary/5 hover:shadow-md transition-all duration-300"
