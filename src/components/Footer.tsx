    ...
    <footer className="border-t border-border bg-secondary/50 py-12">
      <div className="container">
        <div className="grid gap-8 md:grid-cols-3">
          {/* Brand */}
          <div>
            <p className="font-serif text-lg font-semibold text-foreground">Célia Franz</p>
          ...
          {/* Nav */}
          <div>
            <p className="mb-3 text-sm font-semibold uppercase tracking-wider text-foreground">Formações</p>
          ...
          {/* Contact */}
          <div>
            <p className="mb-3 text-sm font-semibold uppercase tracking-wider text-foreground">Contato</p>
